...
# st.image(
#     "https://kgptalkie.com/wp-content/uploads/2019/03/cropped-iPad-Pro-Copy@2x-1.png",
#     caption="KGP Talkie Logo",
#     width=100,
# )
...
# st.video("https://www.youtube.com/watch?v=9NiWe4y7LC0", format="video/mp4")
...
# st.download_button(
#     label="Download Example Text", data=download_data, file_name="example.txt"
# )
